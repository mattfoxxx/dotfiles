...
files=".tmux.conf .tmuxinator .vimrc .vim bin .Xresources .extend.Xresources .config/i3 .config/polybar .config/libinput-gestures.conf"    # list of files/folders to symlink in homedir
